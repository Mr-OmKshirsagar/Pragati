...
export default function AdminOverview() {
  ...
  const attentionItems: AttentionItem[] = [
    {
      id: "1",
      title: "Internship Verifications Pending Seal",
      count: 23,
      action: "Review Queue",
      route: "/admin/verification",
      priority: "critical",
      description: "Faculty approved · Awaiting institutional tamper-proof seal",
    },
    {
      id: "2",
      title: "Assessment Anomaly Flags Detected",
      count: 12,
      action: "Inspect Logs",
      route: "/admin/assessments",
      priority: "high",
      description: "Deterministic Rule #4: Unusual completion velocity detected",
    },
    {
      id: "3",
      title: "Curricular Skill Gaps Awaiting Action",
      count: 34,
      action: "View Hotspots",
      route: "/admin/skills",
      priority: "medium",
      description: "3 departments flagged with consecutive cycle dips",
    },
    {
      id: "4",
      ...
      route: "/admin/users",
      priority: "medium",
      description: "Institutional email verified · Role assignment needed",
    },
    {
      id: "5",
      title: "Security Checkpoints Flagged",
      count: 2,
      action: "Investigate",
      route: "/admin/security",
      priority: "critical",
      description: "Off-campus credential verification attempt from untrusted IP",
    },
  ];
